using Backtest.App.Commands;
using Backtest.ChainProviders.Evm;
using Backtest.ChainProviders.Transport;
using Backtest.ChainProviders.Utxo;
using Backtest.Cryptography.Derivation;
using Backtest.Cryptography.Vault;
using Backtest.Engine.Analytics;
using Backtest.Engine.Domain.Contracts;
using Backtest.Engine.Networks;
using Backtest.Engine.Options;
using Backtest.Engine.Orchestration;
using Backtest.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace Backtest.App.Bootstrap;
